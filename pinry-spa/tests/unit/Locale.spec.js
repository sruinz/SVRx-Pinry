...
const EXPECTED_LOCALE_KEYS = [
  'pinEditAction', 'boardEditAction', 'pinRemoveFromBoardAction',
  ...
  'profileTokenCopy',
  'profileTokenCopied',
  'profileTokenCopyFailed',
  'profilePinryPassword',
  ...
  'ssoUnavailable',
  'ssoUnlink',
  'ssoUnlinkBlockedLastLoginMethod',
  'ssoUnlinkIdentityNotFound',
  'ssoUnlinkRecentAuthRequired',
  ...
  'boardOrderEnter',
  'boardOrderHandle',
  'boardOrderLoadFailed',
  'boardOrderLoading',
  'boardOrderMismatch',
  'boardOrderMoveBackward',
  'boardOrderMoveForward',
  'boardOrderMoved',
  'boardOrderPicked',
  'boardOrderRefreshRequired',
  'boardOrderReleased',
  'boardOrderSave',
  'boardOrderSaveFailed',
  'boardOrderSaved',
  'boardSortCustom',
  'boardSortLabel',
  'boardSortLatest',
...
const REQUIRED_KOREAN_TEXT = {
  ...
  ssoReauthHelp: 'SSO 제공자가 본인을 다시 확인하면 5분간 유효합니다. 하지만 마지막으로 사용할 수 있는 로그인 수단 해제는 허용하지 않습니다. 제공자의 기존 로그인 상태에 따라 비밀번호 입력 없이 완료될 수 있습니다.',
  ...
  boardSortLabel: '정렬',
  boardSortCustom: '사용자 지정',
  boardSortLatest: '최신순',
  boardSortOldest: '오래된순',
  boardSortRandom: '랜덤',
  boardOrderEnter: '순서 편집',
  boardOrderSave: '저장',
  boardOrderCancel: '취소',
  boardOrderMoveForward: '앞으로',
  boardOrderMoveBackward: '뒤로',
  boardOrderRefreshRequired: 'Board 순서가 다른 곳에서 변경되었습니다. 새로고침한 뒤 다시 시도하세요.',
  ...
  dependencyVersionsTitle: '의존성 버전',
  profileTokenTitle: 'API 토큰',
  profileTokenDescription: 'API 연동에 사용하는 개인 토큰입니다.',
  profileTokenShow: '표시',
  profileTokenHide: '숨기기',
  profileTokenCopy: '복사',
  profileTokenCopied: '토큰을 복사했습니다.',
  profileTokenCopyFailed: '복사할 수 없습니다. 토큰을 표시한 뒤 직접 선택해 복사하세요.',
  profilePinryPassword: 'Pinry 비밀번호',
  profileCurrentPassword: '현재 비밀번호',
  profileConnected: '연결됨',
  profileAdminHelp: '서버와 로그인 정책을 관리합니다.',
  profileAdminOpen: '설정 열기',
  profileBackend: '백엔드',
  profileFrontend: '프런트엔드',
  profileBuildTools: '빌드 도구',
  profileBuildToolsHelp: '빌드 도구는 프런트엔드 빌드에 사용된 버전입니다.',
