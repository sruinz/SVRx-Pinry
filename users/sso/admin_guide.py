...
PROVIDER_GUIDES = {
    'authentik': {
        ...
        'steps': ['Applications에서 OAuth2/OpenID 제공자와 애플리케이션을 만드세요.',
                  ...
                  'Client ID·Client Secret·Discovery URL을 입력하세요. 발급자는 자동 확인합니다.'],
    ...
    'synology': {
        ...
        'steps': ['SSO Server에서 OIDC 서버를 활성화하세요.',
                  ...
                  '응용 프로그램 ID·비밀·Well-known URL을 입력하세요. 발급자는 자동 확인합니다.'],
    ...
    'oidc': {
        ...
        'steps': ['제공자에서 서버용 OIDC 클라이언트를 만드세요.',
                  ...
                  'Client ID·비밀·Discovery URL을 입력하세요. 발급자는 자동 확인합니다.'],
